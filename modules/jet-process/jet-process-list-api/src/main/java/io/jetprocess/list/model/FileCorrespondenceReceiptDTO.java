...
public class FileCorrespondenceReceiptDTO {
		...
		public FileCorrespondenceReceiptDTO(long receiptId, long receiptMovementId, String receiptNumber,
				String subject, String category, Date createDate, String remark, String viewPdfUrl, String nature,
		...
		public String toString() {
			return "FileCorrespondenceReceiptDTO [receiptId=" + receiptId + ", receiptMovementId=" + receiptMovementId
					...
					+ nature + ", correspondenceType=" + correspondenceType + "]";
		}
