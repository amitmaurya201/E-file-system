...
/**
 * Provides the local service interface for ContactDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ContactDetailLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ContactDetailLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>io.jetprocess.service.impl.ContactDetailLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the contact detail local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ContactDetailLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ContactDetail addContactDetails(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ContactDetail> getContactDetailByGroupId(
	...
	public ContactDetail updateContactDetail(
