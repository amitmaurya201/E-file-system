...
public interface FileRsModelResource {
	...
	public HttpInvoker.HttpResponse updateDocFileHttpResponse(
			FileRsModel fileRsModel)
		throws Exception;
	...
	public static class Builder {
		...
		public FileRsModelResource build() {
			return new FileRsModelResourceImpl(this);
		}
	...
	public static class FileRsModelResourceImpl implements FileRsModelResource {
		...
		public HttpInvoker.HttpResponse createFileHttpResponse(
			...
			httpInvoker.body(fileRsModel.toString(), "application/json");
		...
		public FileRsModel updateDocFile(FileRsModel fileRsModel)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = updateDocFileHttpResponse(
				fileRsModel);
		...
		public HttpInvoker.HttpResponse updateDocFileHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/jet-process-rs/v1.0/updateDocFile");
		...
		private FileRsModelResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			FileRsModelResource.class.getName());
