	...
	<div class="col-10">
		...
		<div class="border border-dark m-1 receipt">
			<aui:container cssClass="row">
				...
				<aui:form cssClass="border border-dark col-6" name="receiptForm"
					id="receiptForm">
								...
								<aui:col md="6" cssClass="mt-3">
									<div class="textOnInput">
										...
										<aui:input label="" name="referenceNumber"
											id="referenceNumber" value="${receipt.referenceNumber}" />
								...
								<aui:col cssClass="mt-3">
									<div class="textOnInput">
										...
										<aui:input type="textarea" label="" name="address"
											id="address" value="${receipt.address}">
											<aui:validator name="required" />
								...
								<aui:col cssClass="mt-3">
									<div class="textOnInput">
										...
										<aui:input type="textarea" label="" name="subject"
											id="subject" value="${receipt.subject}">
											<aui:validator name="required" />
											<aui:validator name="maxLength">500</aui:validator>
										</aui:input>
									</div>
