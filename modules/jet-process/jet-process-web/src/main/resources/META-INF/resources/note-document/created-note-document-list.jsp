...
<%-- <div class="row">
	...
	<h1>created - note document -list page </h1>
	</div>
 --%>
...
<%-- 
 ...
 --%>
			<%-- 	<c:set var="firstLetterOfNature" value="${noteDocument.noteDocumentId}" />
				<c:set var="nature"
				...
				<liferay-ui:search-container-column-text
					value="<%=noteDocument.getCreatedOn() != null ? noteDocument.getCreatedOn() : ""%>"
