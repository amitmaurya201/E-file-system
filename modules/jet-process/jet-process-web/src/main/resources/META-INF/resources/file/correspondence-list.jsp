...
<%
	...
	List<FileCorrespondenceReceiptDTO> receiptCorrList = MasterdataLocalServiceUtil
			.getFileCorrespondenceReceipteDetail(corrFileId);
	...
	<liferay-ui:search-container total="<%=receiptCorrList.size()%>"
		...
		<liferay-ui:search-container-row
			...
			<liferay-ui:search-container-column-text name="Attached On"
				value="<%=simpleformat.format(aFileCorrespondenceReceiptDTO.getCreateDate())%>" />
