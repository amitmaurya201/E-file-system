 ...
 * 
 * import io.jetprocess.web.constants.JetProcessWebPortletKeys; import
 * io.jetprocess.web.constants.MVCCommandNames;
 * 
 * 
 * @Component( immediate = true, property = { "javax.portlet.name=" +
 * JetProcessWebPortletKeys.JETPROCESSWEB,
 * "mvc.command.name="+MVCCommandNames.VIEW_FILELIST }, service =
 ...
 * System.out.println("view/home page --called"); return
 * "/file/created-file-list.jsp"; }
 * 
 * 
 * 
 * }
